...
/**
 * Class: LightSeasonActivity
 * Version: 1.0
 * Parameters: - seasonList
 *             - channelsNamesList
 *             - lightModeList
 *             - lightProgramList
 * Return: - Activity result
 *         - lightUpdateList
 * Perform: All actions in light_season layout
 * Created: 29/03/16
 * Creator: Lucas Gabriel N. Milagres
 */
public class LightSeasonActivity extends Activity
{
    //Intents
    Intent sendIntent;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.light_season);
    ...
    private void ChannelNamesInitialize()
    {
        ...
        if((channelsNamesList != null)&&(channelsNamesList.size()==5))
        {
            ...
            TextView channelName1Field = (TextView)findViewById(R.id.light_season_channel1_name);
            TextView channelName2Field = (TextView)findViewById(R.id.light_season_channel2_name);
            TextView channelName3Field = (TextView)findViewById(R.id.light_season_channel3_name);
            TextView channelName4Field = (TextView)findViewById(R.id.light_season_channel4_name);
            TextView channelName5Field = (TextView)findViewById(R.id.light_season_channel5_name);
     ...
     * Parameters: Void
     * Return: void
     * Perform: - Reads seasonList
     *          - Sets spinner' dropdown to actual seasonList values
    ...
    {
        //Reads seasonList
        ArrayList<String> seasonList=sendIntent.getStringArrayListExtra("seasonList");
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.spinner_item, seasonList);
        adapter.setDropDownViewResource(R.layout.spinner_dropdown_item);

        //Finds all spinners in the activity
        ArrayList<Spinner> channelSpinnerList=new ArrayList<>();
        channelSpinnerList.add((Spinner) findViewById(R.id.light_season_spinner1));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_season_spinner2));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_season_spinner3));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_season_spinner4));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_season_spinner5));
        ...
        for(int count=0; count<=4;count++)
        {
            ...
            //Avoids using obsolete programs
            if(!seasonList.contains(lightProgramList.get(count)))
                lightProgramList.set(count,getResources().getString(R.string.Unset));

            //Selects spinner item
            if(channelSpinnerList.size()==5)
                channelSpinnerList.get(count).setSelection(seasonList.indexOf(lightProgramList.get(count)));
            else
    ...
    private void ChannelEnabledInitialize()
    {
        ...
        {
            //Seeks SeasonMode channels
            for (int count=0;count<=4;count++)
            {
                if(lightModeList.get(count).equals(getResources().getString(R.string.SeasonMode)))
    ...
    private void changeEnabledState(int channelIndex, boolean checkBoxStatus)
    {
        ...
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_season_checkBox1));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_season_checkBox2));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_season_checkBox3));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_season_checkBox4));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_season_checkBox5));
