 ...
 *         - lightUpdateList
 * Perform: All actions in light_location layout
 * Created: 29/03/16
 * Creator: Lucas Gabriel N. Milagres
 */
public class LightLocationActivity extends Activity
{
    //Intents
    Intent sendIntent;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.light_location);
    ...
    private void ChannelNamesInitialize()
    {
        ...
        if((channelsNamesList != null)&&(channelsNamesList.size()==5))
        {
            ...
            TextView channelName1Field = (TextView)findViewById(R.id.light_location_channel1_name);
            TextView channelName2Field = (TextView)findViewById(R.id.light_location_channel2_name);
            TextView channelName3Field = (TextView)findViewById(R.id.light_location_channel3_name);
            TextView channelName4Field = (TextView)findViewById(R.id.light_location_channel4_name);
            TextView channelName5Field = (TextView)findViewById(R.id.light_location_channel5_name);
     ...
     * Parameters: Void
     * Return: void
     * Perform: - Reads locationList
     *          - Sets spinner' dropdown to actual locationList values
    ...
    {
        //Reads locationList
        ArrayList<String> locationList=sendIntent.getStringArrayListExtra("locationList");
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.spinner_item, locationList);
        adapter.setDropDownViewResource(R.layout.spinner_dropdown_item);

        //Finds all spinners in the activity
        ArrayList<Spinner> channelSpinnerList=new ArrayList<>();
        channelSpinnerList.add((Spinner) findViewById(R.id.light_location_spinner1));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_location_spinner2));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_location_spinner3));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_location_spinner4));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_location_spinner5));
        ...
        for(int count=0; count<=4;count++)
        {
            ...
            //Avoids using obsolete programs
            if(!locationList.contains(lightProgramList.get(count)))
                lightProgramList.set(count,getResources().getString(R.string.Unset));

            //Selects spinner item
            if(channelSpinnerList.size()==5)
                channelSpinnerList.get(count).setSelection(locationList.indexOf(lightProgramList.get(count)));
            else
     ...
     *          - Identify LocationMode channels
     * Created: 29/03/16
     * Creator: Lucas Gabriel N. Milagres
     */
    private void ChannelEnabledInitialize()
    {
        ...
        {
            //Seeks LocationMode channels
            for (int count=0;count<=4;count++)
            {
                if(lightModeList.get(count).equals(getResources().getString(R.string.LocationMode)))
    ...
    private void changeEnabledState(int channelIndex, boolean checkBoxStatus)
    {
        ...
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_location_checkBox1));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_location_checkBox2));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_location_checkBox3));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_location_checkBox4));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_location_checkBox5));
