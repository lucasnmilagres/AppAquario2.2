 ...
 */
public class SetTempData extends AsyncTask<String,Void,String>
{
    Exception exception;
    TemperatureActivity temperatureActivity;

    public SetTempData(TemperatureActivity temperatureActivity)
    {
    ...
    protected String doInBackground(String... urls)
    {
        ...
        InputStream is=null;
        try{
            url=new URL(urls[0]+urls[1]+urls[2]+urls[3]+urls[4]);
    ...
    protected void onPostExecute(String result_msg)
    {
        ...
        temperatureActivity.finishActivity(result_msg);
    }
}
