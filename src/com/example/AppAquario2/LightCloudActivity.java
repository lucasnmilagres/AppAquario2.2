...
/**
 * Class: LightCloudActivity
 * Version: 1.0
 * Parameters: - channelsNamesList
 *             - cloudEnabledArray
 * Return: - Activity result
 *         - cloudEnabledUpdateList
 * Perform: All actions in light_cloud layout
 * Created: 01/04/16
 * Creator: Lucas Gabriel N. Milagres
 */
public class LightCloudActivity extends Activity
{
    //Intents
    Intent sendIntent;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.light_cloud);
    ...
    private void ChannelNamesInitialize()
    {
        ...
        if((channelsNamesList != null)&&(channelsNamesList.size()==5))
        {
            ...
            TextView channelName1Field = (TextView)findViewById(R.id.light_cloud_channel1_name);
            TextView channelName2Field = (TextView)findViewById(R.id.light_cloud_channel2_name);
            TextView channelName3Field = (TextView)findViewById(R.id.light_cloud_channel3_name);
            TextView channelName4Field = (TextView)findViewById(R.id.light_cloud_channel4_name);
            TextView channelName5Field = (TextView)findViewById(R.id.light_cloud_channel5_name);
     ...
     * Parameters: Void
     * Return: void
     * Perform: - Reads actual cloudEnabledArray
     *          - Identify cloud enabled channels
     * Created: 01/04/16
     * Creator: Lucas Gabriel N. Milagres
     */
    private void CheckBoxesInitialize()
    {
        ...
        boolean[] cloudEnabledArray = sendIntent.getBooleanArrayExtra("cloudEnabledArray");

        //Sets actual enabled channels
        if ((cloudEnabledArray != null) && (cloudEnabledArray.length == 5))
        {
            //Seeks enabled cloud channels
            for (int count=0;count<=4;count++)
            {
                if(cloudEnabledArray[count])
    ...
    private void changeEnabledState(int channelIndex, boolean checkBoxStatus)
    {
        ...
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_cloud_checkBox1));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_cloud_checkBox2));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_cloud_checkBox3));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_cloud_checkBox4));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_cloud_checkBox5));
