 ...
 *         - lightUpdateList
 * Perform: All actions in light_moon layout
 * Created: 29/03/16
 * Creator: Lucas Gabriel N. Milagres
 */
public class LightMoonActivity extends Activity
{
    //Intents
    Intent sendIntent;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.light_moon);
    ...
    private void ChannelNamesInitialize()
    {
        ...
        if((channelsNamesList != null)&&(channelsNamesList.size()==5))
        {
            ...
            TextView channelName1Field = (TextView)findViewById(R.id.light_moon_channel1_name);
            TextView channelName2Field = (TextView)findViewById(R.id.light_moon_channel2_name);
            TextView channelName3Field = (TextView)findViewById(R.id.light_moon_channel3_name);
            TextView channelName4Field = (TextView)findViewById(R.id.light_moon_channel4_name);
            TextView channelName5Field = (TextView)findViewById(R.id.light_moon_channel5_name);
     ...
     * Parameters: Void
     * Return: void
     * Perform: - Reads moonList
     *          - Sets spinner' dropdown to actual moonList values
    ...
    {
        //Reads moonList
        ArrayList<String> moonList=sendIntent.getStringArrayListExtra("moonList");
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.spinner_item, moonList);
        adapter.setDropDownViewResource(R.layout.spinner_dropdown_item);

        //Finds all spinners in the activity
        ArrayList<Spinner> channelSpinnerList=new ArrayList<>();
        channelSpinnerList.add((Spinner) findViewById(R.id.light_moon_spinner1));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_moon_spinner2));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_moon_spinner3));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_moon_spinner4));
        channelSpinnerList.add((Spinner) findViewById(R.id.light_moon_spinner5));
        ...
        for(int count=0; count<=4;count++)
        {
            ...
            //Avoids using obsolete programs
            if(!moonList.contains(lightProgramList.get(count)))
                lightProgramList.set(count,getResources().getString(R.string.Unset));

            //Selects spinner item
            if(channelSpinnerList.size()==5)
                channelSpinnerList.get(count).setSelection(moonList.indexOf(lightProgramList.get(count)));
            else
    ...
    private void ChannelEnabledInitialize()
    {
        ...
        {
            //Seeks MoonMode channels
            for (int count=0;count<=4;count++)
            {
                if(lightModeList.get(count).equals(getResources().getString(R.string.MoonMode)))
    ...
    private void changeEnabledState(int channelIndex, boolean checkBoxStatus)
    {
        ...
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_moon_checkBox1));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_moon_checkBox2));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_moon_checkBox3));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_moon_checkBox4));
        channelCheckBoxList.add((CheckBox) findViewById(R.id.light_moon_checkBox5));
